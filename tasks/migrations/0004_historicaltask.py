...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('tasks', '0003_backfill_task_soft_delete_flags'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ...
                ('parent', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='tasks.task')),
